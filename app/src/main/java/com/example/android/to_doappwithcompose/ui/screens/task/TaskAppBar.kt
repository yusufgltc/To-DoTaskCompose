...
import com.example.android.to_doappwithcompose.ui.theme.topAppBarBackgroundColor
...
@Preview
@Composable
fun ExistingAppBarPrev() {
    ExistingTaskAppBar(
        selectedTask = ToDoTask(id = 0, title = "Yusuf", description = "Some Random Task", priority = Priority.LOW),
